# Script for ISTA 421 / INFO 521 Fall 2017, HW 2, Problem 4
...
#       You will get a syntax error on line 416 because w has not been defined
...
def plot_cv_results(train_loss, cv_loss, ind_loss=None, log_scale_p=False,
    ...
    :param filepath: If specified, saves pdf file
    :return:
    """
...
def run_cv( K, maxorder, x, t, testx, testt, randomize_data=False, title='CV' ):
    ...
    for p in range(maxorder + 1):
        ...
        for fold in range(K):
            ...
            ### YOUR CODE HERE
            w = numpy.dot(numpy.linalg.inv(numpy.dot(numpy.transpose(trainX),trainX)),numpy.dot(numpy.transpose(trainX),traint))  # Calculate w vector (as an numpy.array)
