...
def compute_gradient_numerical_estimate(J, theta):
    epsilon=0.0001
    """
    ...
    for i in(range(numThetaRows)):
     ...
     print('thetaMinusEpsilon__________________________________',(thetaPlusEpsilon))
     print('J(thetaPlusEpsilon)[0]__________________________________',(J(thetaPlusEpsilon)))     
     gradient[i] = (J(thetaPlusEpsilon)[0] - J(thetaMinusEpsilon)[0]) / (2 * epsilon)
     print('gradient[i]__________________________________',gradient[i])    
    return gradient
