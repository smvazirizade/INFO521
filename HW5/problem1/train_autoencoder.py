...
hidden_size = 10                                                                                                   # 50 is the correct one
...
print('load_MNIST called by mohsen successfully')
# Each column represents one 28x28 pixel image (784 total pixels) that has
# been "unrolled" into a 784-element column vector.
patches_train = images[:, 0:1]  # grabs the first 100 images (i.e., the first 100 columns)
print('called2')
