...
###images = load_MNIST.load_MNIST_images('E:/courses/INFO521/HW5/1/data/mnist/train-images-idx3-ubyte')
images = load_MNIST.load_MNIST_images('E:/courses/INFO521/HW5/1/data/mnist/train-images.idx3-ubyte')
print('load_MNIST called correctly by mohsen successfully')
